...
const ServiceHeadings_entity_1 = require("../entity/ServiceHeadings.entity");
...
const heading_general_details = new ServiceHeadings_entity_1.ServiceHeadings();
heading_general_details.id = 1;
const heading_demographics = new ServiceHeadings_entity_1.ServiceHeadings();
heading_demographics.id = 2;
const heading_eligibility = new ServiceHeadings_entity_1.ServiceHeadings();
heading_eligibility.id = 3;
const heading_service_model = new ServiceHeadings_entity_1.ServiceHeadings();
heading_service_model.id = 4;
const heading_offerings = new ServiceHeadings_entity_1.ServiceHeadings();
heading_offerings.id = 5;
const service_details_options = [
...
function seedRegistrationOption() {
    return __awaiter(this, void 0, void 0, function* () {
        yield new Promise((resolve, reject) => {
            connection.query('SET FOREIGN_KEY_CHECKS = 0', (err) => {
                if (err) {
