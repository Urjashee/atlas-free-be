...
exports.serviceManagerMiddleware = void 0;
...
const serviceManagerMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    let token;
    if (req.headers.authorization && req.headers.authorization.startsWith('Bearer')) {
        token = req.headers.authorization.split(' ')[1];
    }
    try {
        const ADVISOR_ROLE_ID = Constants_helper_1.Constants.ROLE_SERVICE_MANAGER;
        const decoded = jsonwebtoken_1.default.decode(token);
        if (!decoded || decoded.role !== ADVISOR_ROLE_ID) {
            return response_1.ResponseFormatter.unauthorizedResponse(res, 'Not a service manager user');
        }
        next();
    }
    catch (error) {
