...
export async function getOrganizationsServiceDetails(service: any, roleId?: number) {
    ...
    return {
        ...
        physical_accommodation_others: service?.physical_accommodation_others ?? null,
        ...
        // data: service?.organization ?? null,
        organization: {
            "id": service?.organization?.id ?? "",
            "name": service?.organization?.name ?? "",
            "street": service?.organization?.street ?? "",
            "address": service?.organization?.address ?? "",
            "city": service?.organization?.address ?? "",
            "zipcode": service?.organization?.zipcode ?? "",
            "disclose_address": service?.organization?.disclose_address ?? "",
...
export async function getOrganizationsDetails(organization: any, filter?: string, role?: number) {
    ...
    return {
        ...
        email: organization.organization.default_user?.email ?? organization.email,
        user_id: organization?.organization?.default_user?.id ?? "",
