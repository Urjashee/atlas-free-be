...
`;
export const RejectOrganization = (name: string, email: string, token: string, type: number, role?: number) => `
<!DOCTYPE html>
<html>
<head>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear ${email},</p>
            <p>Thank you for your patience</p>
            <p>Your organization application has been rejected</p>
...
export const PendingOrganization = (name: string, email: string, token: string, type: number, role?: number) => `
<!DOCTYPE html>
<html>
<head>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Dear ${email},</p>
            <p>Thank you for your patience</p>
            <p>Your organization edited license has been rejected</p>
