...
const service_details_options: ServiceDetailsOptions[] = [
    ...
    {id: 27, name: 'Sex Trafficking', type: 'trafficking_status', serviceHeading: heading_eligibility},
    {id: 28, name: 'Labor Trafficking', type: 'trafficking_status', serviceHeading: heading_eligibility},
    {id: 29, name: 'Prostitution', type: 'trafficking_status', serviceHeading: heading_eligibility},
    {id: 30, name: 'Survival Sex', type: 'trafficking_status', serviceHeading: heading_eligibility},
    {id: 31, name: 'Other forms of commercial sex', type: 'trafficking_status', serviceHeading: heading_eligibility},
...
const advocate_service: AdvocateService[] = [
    ...
    {id: 4, name: 'Asian (Far East, Southeast Asia, or the Indian subcontinent. India, China, the Philippine Islands, Japan, Korea, or Vietnam, Asian Indian, Chinese, Filipino, Korean, Japanese, Vietnamese, Other Asian, Pakistani, Cambodian, Hmong, Thai, Bengali, Mien, etc.)', type: 'race_ethnicity'},
    {id: 5, name: 'Native Hawaiian and Other Pacific Islander (Hawaii, Guam, Samoa, Pacific Islands, Native Hawaiian, Chamorro, Samoan, Other Pacific Islander, Pacific Islander, Palauan, Tahitian, Chuukese, Pohnpeian, Saipanese, Yapese, etc.)', type: 'race_ethnicity'},
    {id: 6, name: 'American Indian and Alaska Native (North and South America, race as "American Indian or Alaska Native", Navajo Nation, Blackfeet Tribe, Mayan, Aztec, Native Village of Barrow Inupiat, or Nome Eskimo Community.)', type: 'race_ethnicity'},
    {id: 7, name: 'Black or African American (Black racial groups of Africa. Such as African American, Jamaican, Haitian, Nigerian, Ethiopian, or Somali, Ghanaian, South African, Barbadian, Kenyan, Liberian, Bahamian, etc.)', type: 'race_ethnicity'},
    {id: 8, name: 'White (Europe, the Middle East, or North Africa, German, Irish, English, Italian, Lebanese, Egyptian, Polish, French, Iranian, Slavic, Cajun, Chaldean, etc.)', type: 'race_ethnicity'},
